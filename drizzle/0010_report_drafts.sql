-- Migration 0010: Report Drafts and Generated Reports tables for the Report Builder
CREATE TABLE IF NOT EXISTS `report_drafts` (
	...
	INDEX `idx_report_drafts_project_id` (`project_id`),
	INDEX `idx_report_drafts_step` (`step`)
);
...
CREATE TABLE IF NOT EXISTS `generated_reports` (
	...
	INDEX `idx_generated_reports_project_id` (`project_id`),
	INDEX `idx_generated_reports_draft_id` (`draft_id`)
);
